@echo off
rem ReadIt clean rebuild wrapper: clean + unit tests + assembleDebug.
...
call "<LOCAL_HOME>\.gradle\wrapper\dists\gradle-8.13-bin\5xuhj0ry160q40clulazy9h7d\gradle-8.13\bin\gradle.bat" -p "<LOCAL_HOME>\WorkBuddy\ReadIt" --console=plain clean :app:testDebugUnitTest :app:assembleDebug > "<LOCAL_HOME>\WorkBuddy\ReadIt\.workbuddy\tmp\build.log" 2>&1
